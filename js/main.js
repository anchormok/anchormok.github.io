...
const I18N = {
  en: {
    ...
    "nav.news": "News",
    "nav.contact": "Contact",
    "hero.eyebrow": "Postdoctoral Researcher · CAR-T & Hematologic Malignancies",
    ...
    "hero.tagline": "Advancing CAR-T cell therapy and therapeutic target discovery in blood cancers through single-cell multi-omics.",
    ...
    "about.p3": "My current work focuses on CAR-T cell therapy, the discovery of therapeutic targets in hematologic malignancies, and dissecting the immunosuppressive microenvironment through single-cell multi-omics. This work has been published in Cancer Discovery (accepted), the New England Journal of Medicine and Cell Reports Medicine.",
    "about.chip1": "CAR-T Cell Therapy",
    "about.chip2": "Hematologic Malignancies",
    "about.chip3": "Therapeutic Target Discovery",
    "about.chip4": "Single-cell Multi-omics",
    ...
    "about.award1Title": "Guangdong Province Outstanding Graduate",
    "about.award1Meta": "2019",
    "about.award2Title": "Baosteel Outstanding Student",
    "about.award2Meta": "2020",
    "about.award3Title": "Liangzhu Laboratory Academic Poster",
    "about.award3Meta": "2nd Prize · 2024",
  ...
  zh: {
    ...
    "nav.news": "最新动态",
    "nav.contact": "联系方式",
    "hero.eyebrow": "博士后研究员 · CAR-T与血液肿瘤",
    "hero.subtitle": "浙江大学医学院附属第一医院骨髓移植中心 & 良渚实验室",
    "hero.tagline": "以单细胞多组学为利器，推进CAR-T细胞治疗与血液肿瘤靶点发现。",
    "hero.btnPapers": "查看论文",
    ...
    "about.p3": "现阶段的工作主要聚焦于CAR-T细胞治疗、血液肿瘤治疗靶点的挖掘，以及基于单细胞多组学剖析免疫抑制微环境等。相关成果发表于《Cancer Discovery》（已接收）、《新英格兰医学杂志》（NEJM）与《Cell Reports Medicine》。",
    "about.chip1": "CAR-T细胞治疗",
    "about.chip2": "血液肿瘤",
    "about.chip3": "治疗靶点挖掘",
    "about.chip4": "单细胞多组学",
    ...
    "about.awardsTitle": "获奖荣誉",
    "about.award1Title": "广东省优秀毕业生",
    "about.award1Meta": "2019年",
    "about.award2Title": "宝钢优秀学生",
    "about.award2Meta": "2020年",
    "about.award3Title": "良渚实验室学术墙报",
    "about.award3Meta": "二等奖 · 2024年",
    "research.kicker": "研究",
    "research.title": "研究方向",
